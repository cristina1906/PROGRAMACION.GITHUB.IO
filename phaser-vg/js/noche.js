...
function preload(){
    game.load.spritesheet("noche", "sprites/blanco.png", 64, 64);
    game.load.image("desert", "fondos/night2.jpg");
};
...
function create(){
    ...
    player = game.add.sprite(game.width / 2, game. height / 2, "noche");     //SE pone /2, para poner el personej en medio
